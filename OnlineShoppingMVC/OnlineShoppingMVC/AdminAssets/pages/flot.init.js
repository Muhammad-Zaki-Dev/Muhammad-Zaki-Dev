...
!function($) {
    ...
    FlotChart.prototype.createDonutGraph = function(selector, labels, datas, colors) {
        ...
        var Mobile = [[0, 20], [1, 80], [2, 70], [3, 140], [4, 250], [5, 80], [6, 200]];
          var plabels = ["Desktops","Laptops","Tablets","Mobile"];
        var pcolors = ['#f0f1f4', '#28bbe3', '#f16c69',"#28bbe8"];
         ...
         // this.createPlotGraph("#website-stats", desktops, laptops, tablets, plabels, pcolors, borderColor, bgColor);
          ...
          var datas = [20,30, 15];
          var colors = ['#f16c69','#28bbe3', "#ebeff2"];
          this.createPieGraph("#pie-chart #pie-chart-container ", pielabels, datas, colors);
        //Pie graph data 1
            //var pielabels = ["Desktops", "Laptops", "Tablets"];
            //var datas = [20, 30, 15];
            //var colors = ['#f16c79', '#28bbb3', "#ecccf2"];
            //this.createPieGraph("#pie-chartt #pie-chart-containerr ", pielabels , datas, colors);
          ...
          var donutcolors = ['#f0f1f4', '#f16c69', '#28bbe3'];
